$(document).ready(() => {
    procesarReporteCubosAgua();
});
function procesarReporteCubosAgua(){
    $('#formularioReporteCubosAgua').submit(function(e){
        e.preventDefault();
        console.log(e);

        let formularioReporteCubosAgua = $("#formularioReporteCubosAgua").serialize();
        // lo convierte en un serializa con los & e =
        let objAdmin = serializeToObject(formularioReporteCubosAgua);
