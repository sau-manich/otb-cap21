$(document).ready(() => {
    procesarFormularioReporteAsamblea();
});
function procesarFormularioReporteAsamblea(){
    $('#formularioReporteAsamblea').submit(function(e){
        e.preventDefault();
        console.log(e);

        let formularioReporteAsamblea = $("#formularioReporteAsamblea").serialize();
        // lo convierte en un serializa con los & e =
        let objAdmin = serializeToObject(formularioReporteAsamblea);
